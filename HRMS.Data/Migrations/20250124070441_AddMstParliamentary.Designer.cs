...
namespace TechnicalEducationPortal.Data.Migrations
{
    ...
    [Migration("20250124070441_AddMstParliamentary")]
    partial class AddMstParliamentary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS.Entities.Models.EmployeeInfo", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Entities.Models.MstBlock", b =>
                {
                    ...
                    b.Property<string>("BlockNameEng")
                        .IsRequired()
                        .HasMaxLength(50)
                        .IsUnicode(false)
                        .HasColumnType("varchar");

                    b.Property<string>("BlockNameHin")
                        .IsRequired()
                        .HasMaxLength(60)
            ...
            modelBuilder.Entity("HRMS.Entities.Models.MstDivision", b =>
                {
                    ...
                    b.ToTable("MstDivisions");
                });

            modelBuilder.Entity("HRMS.Entities.Models.MstParliamentary", b =>
                {
                    b.Property<int>("ParliamentaryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ParliamentaryId"));
                    ...
                    b.Property<string>("ParliamentaryCode")
                        .IsRequired()
                        .HasMaxLength(2)
                        .IsUnicode(false)
                        .HasColumnType("varchar(2)");

                    b.Property<string>("ParliamentaryNameEng")
                        .IsRequired()
                        .HasMaxLength(80)
                        .IsUnicode(false)
                        .HasColumnType("varchar(80)");

                    b.Property<string>("ParliamentaryNameHin")
                        .IsRequired()
                        .HasMaxLength(90)
                        .HasColumnType("nvarchar(90)");

                    b.HasKey("ParliamentaryId");

                    b.ToTable("MstParliamentaries");
                });
